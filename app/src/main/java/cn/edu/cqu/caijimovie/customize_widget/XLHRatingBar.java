...
public class XLHRatingBar extends LinearLayout {
    ...
    public XLHRatingBar(Context context, AttributeSet attrs) {
        ...
        mNumStars = typedArray.getInt(com.example.xlhratingbar_lib.R.styleable.XlHRatingBar_numStars, 5);
        mRating = typedArray.getFloat(com.example.xlhratingbar_lib.R.styleable.XlHRatingBar_rating, 0f);
        String ratingViewClassName = typedArray.getString(com.example.xlhratingbar_lib.R.styleable.XlHRatingBar_ratingViewClass);
        try {
