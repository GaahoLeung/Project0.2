...
//        Glide.with(mContext)
//                .load(movie.getCover()).placeholder(R.drawable.ic_hourglass_empty_grey_24dp)
//                .error(R.drawable.ic_error_outline_black_24dp)
//                .fitCenter().into();//into(holder.mPoster);
    }
    ...
    public void initMovieInfo() {
        //Todo:加载电影名称（年份）
        TextView textViewTitleYear = getActivity().findViewById(R.id.card_movie_title_year);
        ...
        //Todo:加载电影标签信息
        TextView textTag = getActivity().findViewById(R.id.card_tags);
        textTag.setText(movie.getShowtime() + "/" + movie.getDistrict() + "/" + "movie.tags" + movie.getDirector() + "/" + movie.getActor());
        //Todo:加载电影片长
        TextView textDuration = getActivity().findViewById(R.id.card_duration);
